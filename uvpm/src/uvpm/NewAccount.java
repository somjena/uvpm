...
public class NewAccount extends JFrame {
	...
	public NewAccount() {
		...
		lblNewLabel.setBounds(48, 129, 109, 24);
		contentPane.add(lblNewLabel);
		
		name = new JTextField();
		name.setBackground(Color.WHITE);
		name.setBounds(210, 128, 280, 36);
		...
		mobile.setBounds(48, 186, 152, 36);
		...
		mobileNo.setBounds(210, 189, 280, 36);
		...
		lblNewLabel_1.setBounds(48, 318, 134, 24);
		contentPane.add(lblNewLabel_1);
		
		newPass = new JTextField();
		newPass.setBounds(210, 306, 280, 36);
		...
		conPass.setBounds(40, 365, 160, 36);
		contentPane.add(conPass);
		
		conPassword = new JPasswordField();
		conPassword.setBounds(212, 368, 278, 36);
		...
		comboBox.setBounds(210, 245, 149, 24);
		...
		create.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                if (len != 10) {
                	...
                	try {
                        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/uvpm", "root", "root");
		...
		create.setBounds(266, 415, 167, 45);
		contentPane.add(create);
		
		JLabel lblNewLabel_2 = new JLabel("User Type :");
		lblNewLabel_2.setFont(new Font("Times New Roman", Font.BOLD, 20));
		lblNewLabel_2.setForeground(Color.BLACK);
		lblNewLabel_2.setBounds(50, 246, 121, 24);
		...
		panel.setBounds(0, 0, 747, 74);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JLabel lblNewLabel_3 = new JLabel("New Account Creation");
		lblNewLabel_3.setForeground(Color.WHITE);
		lblNewLabel_3.setFont(new Font("Times New Roman", Font.BOLD, 25));
		lblNewLabel_3.setBounds(204, 10, 276, 54);
