...
public class HomeAdmin extends JFrame {
	...
	public HomeAdmin() {
		...
		wel.setFont(new Font("Lucida Handwriting", Font.BOLD, 20));
		...
		search.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				scrollPane.setBounds(281, 138, 542, 338);
				contentPane.add(scrollPane);
				
				table = new JTable();
				table.setBounds(281, 138, 542, 338);
		...
		panel_1.setBounds(0, 0, 859, 60);
		contentPane.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblNewLabel_1 = new JLabel(" ");
		lblNewLabel_1.setIcon(new ImageIcon(HomeAdmin.class.getResource("/uvpm/img/loggin.png")));
		lblNewLabel_1.setBounds(379, 138, 311, 383);
